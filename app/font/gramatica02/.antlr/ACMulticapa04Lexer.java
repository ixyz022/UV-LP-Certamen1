...
public class ACMulticapa04Lexer extends Lexer {
	...
	public static final int
		...
		T__24=25, STRING=26, NUMBER=27, WS=28;
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'REGLA'", "'->'", "'SI'", "'HAY'", "'VECINOS'", "'TRANSICIONES POR DURACION'", 
			"'PROBABILIDAD'", "'TRANSICIONES POR CELDA'", "'>='"
		};
	}
	...
	public ACMulticapa04Lexer(CharStream input) {
		super(input);
